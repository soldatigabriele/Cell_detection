...
from utils import visualization_utils_area as vis_util_roi
...
DIR = 'immagini_area_extracellula'
...
FILE_NAME=os.path.join(DIR,'aree.csv'.format(MODEL_NAME,AREA_THRESH,SCORE_THRESH))

with open(FILE_NAME, 'w') as f:
    f.write('dir1,dir2,name,cell_area,drop_area\n')
